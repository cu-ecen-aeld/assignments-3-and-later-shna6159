...
{
    /**
     * Pointer to a mutex that the thread will acquire.
     */
    pthread_mutex_t *mutex;

    /**
     * Number of milliseconds to wait before obtaining the mutex lock.
     */
    int wait_to_obtain_ms;

    /**
     * Number of millisecods to wait before releasing the mutex lock.
     */
